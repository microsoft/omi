...
RUN apt-get install -y pkg-config rpm librpm-dev libpam0g-dev libssl-dev libkrb5-dev wget openssl;
RUN wget http://packages.microsoft.com/config/ubuntu/14.04/packages-microsoft-prod.deb
