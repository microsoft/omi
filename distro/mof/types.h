...
#define CALLOC_T(T, N) ((T*)MOF_Calloc(&state.heap, N, sizeof(T)))
#define MALLOC_T(T, N) ((T*)MOF_Malloc(&state.heap, N * sizeof(T)))
#define REALLOC_T(T, PTR, N) ((T*)MOF_Realloc(&state.heap,PTR,(N)*sizeof(T)))
...
MI_Uint32 GetFlavorFlag(
    char* Flavor);

MI_Uint32 GetScopeFlag(
    char* Scope);
