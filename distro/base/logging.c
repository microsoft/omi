...
// names of SSL_write/read result values
static NameValuePairs SslErrorNames[] =
{
    { 0, "ERROR_NONE" },
    { 1, "ERROR_SSL" },
    { 2, "WANT_READ" },
...
const char* sslstrerror(unsigned long SslError)
{
...
const char* FmtInterval(MI_Sint64 Time)
{
