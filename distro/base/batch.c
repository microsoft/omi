    ...
    size_t size)
{
    ...
    {
        Page* page = malloc(BATCH_PAGE_SIZE);
        char* ptr;
     ...
     */
    {
        Page* page = malloc(sizeof(Page) + size8);
    ...
    size_t pages)
{
    ...
    while (pages)
    {
        ...
        if (!(*self))
        {
            ...
            page = malloc(size8 + sizeof(Batch));
            ...
            *self = (Batch*)(((char*)page) + size8);
            ...
            page = malloc(sizeof(Page) + buffer[pages].pageSize);
