...
/*
    ...
    0 if operation was successful; -1 otherwise
*/
int CreateAuthFile(uid_t uid, _In_reads_(size) char* content, size_t size, _Pre_writable_size_(MAX_PATH_SIZE) char path[MAX_PATH_SIZE]);
...
*/
int FormatLogFileName(uid_t uid, gid_t gid, char path[MAX_PATH_SIZE]);
