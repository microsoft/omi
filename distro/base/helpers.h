...
void DatetimeToStr(const MI_Datetime* x, _Pre_writable_size_(26) ZChar buf[26]);

int ParseWSManDatetime(const ZChar* str, MI_Datetime* x);

void FormatWSManDatetime(const MI_Datetime* x, _Pre_writable_size_(64) ZChar buffer[64]);
