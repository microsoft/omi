    ...
    MI_Uint8 x)
{
    ...
    if (offset + sizeof x > (size_t)self->capacity)
    {
        if (Buf_Reserve(self, (MI_Uint32)(offset + sizeof x)) != MI_RESULT_OK)
            return MI_RESULT_FAILED;
    }

    *((MI_Uint8*)((char*)self->data + offset)) = x;
    self->size = (MI_Uint32)(offset + sizeof x);
    return MI_RESULT_OK;
}
    ...
    MI_Uint32 size)
{
    ...
    if (size != 0)
        MI_RETURN_ERR(Buf_App(self, data, (MI_Uint32)(size * sizeof (MI_Uint16))));
    ...
    MI_Uint32 size)
{
    ...
    if (size != 0)
        MI_RETURN_ERR(Buf_App(self, data, (MI_Uint32)(size * sizeof (MI_Uint32))));
    ...
    MI_Uint32 size)
{
    ...
    if (size != 0)
    {
        ...
        MI_RETURN_ERR(Buf_App(self, data, (MI_Uint32)(size * sizeof (MI_Uint64))));
    }
    ...
    MI_Uint8* x)
{
    ...
    if (offset + sizeof *x > (size_t)self->size)
        return MI_RESULT_FAILED;

    *x = *((MI_Uint8*)((char*)self->data + offset));
    self->offset = (MI_Uint32)(offset + sizeof *x);
    return MI_RESULT_OK;
}
