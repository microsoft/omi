...
static void TestCredUserAllowed()
{
...
static void TestCredInvalidPassword()
{
    // First check that user is not allowed (not added yet)
    UT_ASSERT(CredCache_CheckUser("user", "abc") < 0);
...
static void TestCredSeveralUsers()
{
...
static void TestCredExpiration()
{
...
static void TestCredOldestOverwritten()
{
...
{
    UT_TEST(TestCredUserAllowed);
    UT_TEST(TestCredInvalidPassword);
    UT_TEST(TestCredSeveralUsers);
    UT_TEST(TestCredExpiration);
    UT_TEST(TestCredOldestOverwritten);
}
