...
#if (MI_CHAR_TYPE == 1)
		if(logicalDiskInstanceStore[i]->diskID.value == instanceName->diskID.value && (strcasecmp(logicalDiskInstanceStore[i]->driveLetter.value, instanceName->driveLetter.value) == 0) )
#else
		if(logicalDiskInstanceStore[i]->diskID.value == instanceName->diskID.value && (wcasecmp(logicalDiskInstanceStore[i]->driveLetter.value, instanceName->driveLetter.value) == 0) )
#endif		
		{
    ...
    const MI_PropertySet* propertySet)
{
	...
	{
#if (MI_CHAR_TYPE == 1)
		if(logicalDiskInstanceStore[i]->diskID.value == modifiedInstance->diskID.value && (strcasecmp(logicalDiskInstanceStore[i]->driveLetter.value, modifiedInstance->driveLetter.value) == 0) )
#else
		if(logicalDiskInstanceStore[i]->diskID.value == modifiedInstance->diskID.value && (wcasecmp(logicalDiskInstanceStore[i]->driveLetter.value, modifiedInstance->driveLetter.value) == 0) )
#endif
		{
			instanceFound = MI_TRUE;
    ...
    const Test_LogicalDisk* instanceName)
{
	...
	{		
#if (MI_CHAR_TYPE == 1)
		if((*it)->diskID.value == instanceName->diskID.value && (strcasecmp((*it)->driveLetter.value, instanceName->driveLetter.value) == 0) )
#else
		if((*it)->diskID.value == instanceName->diskID.value && (wcasecmp((*it)->driveLetter.value, instanceName->driveLetter.value) == 0) )
#endif		
		{
			instanceFound = MI_TRUE;
