...
#if(MI_CHAR_TYPE == 1)
		if(strcasecmp(virtualDiskInstanceStore[i]->serialNumber.value, instanceName->serialNumber.value) == 0)
#else
		if(wcasecmp(virtualDiskInstanceStore[i]->serialNumber.value, instanceName->serialNumber.value) == 0)
#endif			
		{
    ...
    const MI_PropertySet* propertySet)
{
	...
	{
#if(MI_CHAR_TYPE == 1)
		if(strcasecmp(virtualDiskInstanceStore[i]->serialNumber.value, modifiedInstance->serialNumber.value) == 0)
#else
		if(wcasecmp(virtualDiskInstanceStore[i]->serialNumber.value, modifiedInstance->serialNumber.value) == 0)
#endif
		{
			instanceFound = MI_TRUE;
