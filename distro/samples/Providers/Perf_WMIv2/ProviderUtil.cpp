...
{	
	...
	sprintf(aString0, MI_T("%s"), MI_T("Embedded String1"));
	sprintf(aString1, MI_T("%s"), MI_T("Embedded String2"));
	sprintf(aString2, MI_T("%s"), MI_T("Embedded String3"));
	sprintf(aString3, MI_T("%s"), MI_T("Embedded String4"));
	sprintf(aString4, MI_T("%s"), MI_T("Embedded String5"));
	...
	case MI_STRING:	
		sprintf(vStringVal, MI_T("%s"), MI_T("Sample string"));
...
MI_Result PostVerbose(MI_Context* context, MI_Char* message, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostWarning(MI_Context* context, MI_Char* message, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostDebug(MI_Context* context, MI_Char* message, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostError(MI_Context* context, MI_Uint32 resultCode, MI_Char* resultType, MI_Char* errorMessage, MI_Boolean* flag, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostProgress(MI_Context* context, MI_Char* activity, MI_Char* currentOperation, MI_Char* statusDescription, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostShouldContinue(MI_Context* context, MI_Char* message, MI_Boolean* flag, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
...
MI_Result PostShouldProcess(MI_Context* context, MI_Char* target, MI_Char* action, MI_Boolean* flag, MI_Uint32 psSemanticsCount)
{
	MI_Result result = MI_RESULT_FAILED;
