	...
	_In_opt_ const Perf_WithPsSemantics_SetBehaviour* in)
{
	...
	Perf_WithPsSemantics_SetBehaviour setBehave;  
	...
	_In_opt_ const Perf_WithPsSemantics_PingBackParameters* in)
{
	...
	Perf_WithPsSemantics_PingBackParameters pingBack; 
	...
	_In_opt_ const Perf_WithPsSemantics_streamingInstances* in)
{
	...
	Perf_WithPsSemantics_streamingInstances streamingInstances;  
	...
	for(MI_Uint32 i = 0; i < self->maxInstances; i++)
	{
		...
		IF_ERROR_DELETE_ARRAY_POST_RETURN(context, result, streamingInstances.__instance, arrInstances, i);
	...
	_In_opt_ const Perf_WithPsSemantics_streamingPrimitive* in)
{
	...
	Perf_WithPsSemantics_streamingPrimitive streamingPrimitives;  
