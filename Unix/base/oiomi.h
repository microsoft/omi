...
#endif
FILE_EVENT1(30108, trace_SockRead_Failed_Impl, LOG_WARNING, PAL_T("Sock_Read: Error %d"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30109, trace_SockReadV_Failed_Impl, LOG_WARNING, PAL_T("Sock_ReadV: Error %d"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30111, trace_SockWriteV_Failed_Impl, LOG_WARNING, PAL_T("Sock_WriteV: Error %d"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(30122, trace_StartRequest_ConnectionClosed_Impl, LOG_WARNING, PAL_T("start-request: connection was closed"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT0(30123, trace_StartRequest_InvalidMagic_Impl, LOG_WARNING, PAL_T("start-request: invalid magic !"))
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT2(30124, trace_WsmanEnumerationcontext_HeartbeatTimeout_Impl, LOG_WARNING, PAL_T("Heartbeat timeout: Sending partial results or heartbeat for enumeration context %p (%u)"), void *, MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30126, trace_AggregationContext_UnhandledState_Impl, LOG_WARNING, PAL_T("Unhandled AggregationContext state %u"), int)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30131, trace_Wsman_InteractionWsman_Right_Post_UnexpectedMessage_Impl, LOG_WARNING, PAL_T("wsman: _InteractionWsman_Right_Post: unexpected message tag %d"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30132, trace_Wsman_InteractionWsmanEnum_Right_Post_UnexpectedMessage_Impl, LOG_WARNING, PAL_T("wsman: _InteractionWsmanEnum_Right_Post: unexpected message tag %d"), MI_Uint32)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30133, trace_Wsman_AuthenticationFailed_Impl, LOG_WARNING, PAL_T("wsman: authentication failed for user [%s]"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(30134, trace_Wsman_UnsupportedAuthentication_Impl, LOG_WARNING, PAL_T("wsman: Unsupported authentication [%s]"), const char *)
#if defined(CONFIG_ENABLE_DEBUG)
...
#endif
FILE_EVENT1(40028, trace_AgentClosedConnection_Impl, LOG_INFO, PAL_T("agent running as [%d] closed its connection to the server"), int)
#if defined(CONFIG_ENABLE_DEBUG)
