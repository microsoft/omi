...
void MI_CALL CIM_Account_Unload(
...
void MI_CALL CIM_Account_EnumerateInstances(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_Account_GetInstance(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_Account_CreateInstance(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_Account_ModifyInstance(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_Account_DeleteInstance(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_Account_Invoke_RequestStateChange(
    _In_opt_ CIM_Account_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
