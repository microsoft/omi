...
MI_INLINE MI_Result MI_CALL CIM_ConcreteJob_GetErrors_Construct(
    _Out_ CIM_ConcreteJob_GetErrors* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructParameters(context, &CIM_ConcreteJob_GetErrors_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_ConcreteJob_GetErrors_Clone(
    _In_ const CIM_ConcreteJob_GetErrors* self,
    _Outptr_ CIM_ConcreteJob_GetErrors** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}
...
MI_INLINE MI_Result MI_CALL CIM_ConcreteJob_GetErrors_Destruct(
    _Inout_ CIM_ConcreteJob_GetErrors* self)
{
    return MI_Instance_Destruct(&self->__instance);
}
...
MI_INLINE MI_Result MI_CALL CIM_ConcreteJob_GetErrors_Set_Errors(
    _Inout_ CIM_ConcreteJob_GetErrors* self,
    _In_reads_opt_(size) const CIM_Error * const * data,
    _In_ MI_Uint32 size)
{
    MI_Array arr;
    arr.data = (void*)data;
...
**==============================================================================
**
** CIM_ConcreteJob provider function prototypes
**
**==============================================================================
*/

/* The developer may optionally define this structure */
typedef struct _CIM_ConcreteJob_Self CIM_ConcreteJob_Self;

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Load(
    _Outptr_result_maybenull_ CIM_ConcreteJob_Self** self,
    _In_opt_ MI_Module_Self* selfModule,
    _In_ MI_Context* context);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Unload(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_EnumerateInstances(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
...
MI_EXTERN_C void MI_CALL CIM_ConcreteJob_GetInstance(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_ const CIM_ConcreteJob* instanceName,
    _In_opt_ const MI_PropertySet* propertySet);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_CreateInstance(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_ const CIM_ConcreteJob* newInstance);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_ModifyInstance(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_ const CIM_ConcreteJob* modifiedInstance,
    _In_opt_ const MI_PropertySet* propertySet);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_DeleteInstance(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Invoke_KillJob(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    ...
    _In_ const CIM_ConcreteJob* instanceName,
    _In_opt_ const CIM_ConcreteJob_KillJob* in);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Invoke_RequestStateChange(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_opt_z_ const MI_Char* methodName,
    _In_ const CIM_ConcreteJob* instanceName,
    _In_opt_ const CIM_ConcreteJob_RequestStateChange* in);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Invoke_GetError(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_opt_z_ const MI_Char* methodName,
    _In_ const CIM_ConcreteJob* instanceName,
    _In_opt_ const CIM_ConcreteJob_GetError* in);

MI_EXTERN_C void MI_CALL CIM_ConcreteJob_Invoke_GetErrors(
    _In_opt_ CIM_ConcreteJob_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
    _In_opt_z_ const MI_Char* methodName,
    _In_ const CIM_ConcreteJob* instanceName,
    _In_opt_ const CIM_ConcreteJob_GetErrors* in);
