...
void MI_CALL CIM_IPProtocolEndpoint_Load(
...
void MI_CALL CIM_IPProtocolEndpoint_Unload(
...
void MI_CALL CIM_IPProtocolEndpoint_EnumerateInstances(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_IPProtocolEndpoint_GetInstance(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_IPProtocolEndpoint_CreateInstance(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_IPProtocolEndpoint_ModifyInstance(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_IPProtocolEndpoint_DeleteInstance(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_IPProtocolEndpoint_Invoke_RequestStateChange(
    _In_opt_ CIM_IPProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
