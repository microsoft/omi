...
void MI_CALL CIM_AutonomousSystem_Load(
...
void MI_CALL CIM_AutonomousSystem_Unload(
...
void MI_CALL CIM_AutonomousSystem_EnumerateInstances(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_AutonomousSystem_GetInstance(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AutonomousSystem_CreateInstance(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AutonomousSystem_ModifyInstance(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AutonomousSystem_DeleteInstance(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AutonomousSystem_Invoke_RequestStateChange(
    _In_opt_ CIM_AutonomousSystem_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
