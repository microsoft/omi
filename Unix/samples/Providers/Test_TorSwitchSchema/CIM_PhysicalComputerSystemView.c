...
void MI_CALL CIM_PhysicalComputerSystemView_Load(
...
void MI_CALL CIM_PhysicalComputerSystemView_Unload(
...
void MI_CALL CIM_PhysicalComputerSystemView_EnumerateInstances(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_PhysicalComputerSystemView_CreateInstance(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_DeleteInstance(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_Invoke_RequestStateChange(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_Invoke_ClearLog(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_Invoke_InstallSoftwareFromURI(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_Invoke_ModifyPersistentBootConfigOrder(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_PhysicalComputerSystemView_Invoke_SetOneTimeBootSource(
    _In_opt_ CIM_PhysicalComputerSystemView_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
