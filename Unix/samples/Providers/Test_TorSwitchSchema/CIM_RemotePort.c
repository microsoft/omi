...
void MI_CALL CIM_RemotePort_Load(
...
void MI_CALL CIM_RemotePort_Unload(
...
void MI_CALL CIM_RemotePort_EnumerateInstances(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_RemotePort_GetInstance(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_RemotePort_CreateInstance(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_RemotePort_ModifyInstance(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_RemotePort_DeleteInstance(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_RemotePort_Invoke_RequestStateChange(
    _In_opt_ CIM_RemotePort_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
