...
MI_INLINE MI_Result MI_CALL CIM_System_Construct(
    _Out_ CIM_System* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructInstance(context, &CIM_System_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_System_Clone(
    _In_ const CIM_System* self,
    _Outptr_ CIM_System** newInstance)
{
...
MI_INLINE MI_Result MI_CALL CIM_System_Destruct(_Inout_ CIM_System* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_System_Delete(_Inout_ CIM_System* self)
{
...
MI_EXTERN_C MI_CONST MI_MethodDecl CIM_System_RequestStateChange_rtti;

MI_INLINE MI_Result MI_CALL CIM_System_RequestStateChange_Construct(
    _Out_ CIM_System_RequestStateChange* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructParameters(context, &CIM_System_RequestStateChange_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_System_RequestStateChange_Clone(
    _In_ const CIM_System_RequestStateChange* self,
    _Outptr_ CIM_System_RequestStateChange** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}

MI_INLINE MI_Result MI_CALL CIM_System_RequestStateChange_Destruct(
    _Inout_ CIM_System_RequestStateChange* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_System_RequestStateChange_Delete(
    _Inout_ CIM_System_RequestStateChange* self)
{
    return MI_Instance_Delete(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_System_RequestStateChange_Post(
    _In_ const CIM_System_RequestStateChange* self,
    _In_ MI_Context* context)
{
    return MI_Context_PostInstance(context, &self->__instance);
