...
void MI_CALL CIM_AdminDomain_Load(
...
void MI_CALL CIM_AdminDomain_Unload(
...
void MI_CALL CIM_AdminDomain_EnumerateInstances(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_AdminDomain_GetInstance(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AdminDomain_CreateInstance(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AdminDomain_ModifyInstance(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AdminDomain_DeleteInstance(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_AdminDomain_Invoke_RequestStateChange(
    _In_opt_ CIM_AdminDomain_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
