...
void MI_CALL CIM_ProtocolEndpoint_Load(
...
void MI_CALL CIM_ProtocolEndpoint_Unload(
...
void MI_CALL CIM_ProtocolEndpoint_EnumerateInstances(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
...
void MI_CALL CIM_ProtocolEndpoint_GetInstance(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_ProtocolEndpoint_CreateInstance(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_ProtocolEndpoint_ModifyInstance(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_ProtocolEndpoint_DeleteInstance(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
...
void MI_CALL CIM_ProtocolEndpoint_Invoke_RequestStateChange(
    _In_opt_ CIM_ProtocolEndpoint_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
