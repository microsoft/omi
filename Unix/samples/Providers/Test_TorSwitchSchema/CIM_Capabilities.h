...
MI_INLINE MI_Result MI_CALL CIM_Capabilities_Construct(
    _Out_ CIM_Capabilities* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructInstance(context, &CIM_Capabilities_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Capabilities_Clone(
    _In_ const CIM_Capabilities* self,
    _Outptr_ CIM_Capabilities** newInstance)
{
...
MI_INLINE MI_Result MI_CALL CIM_Capabilities_Destruct(_Inout_ CIM_Capabilities* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL CIM_Capabilities_Delete(_Inout_ CIM_Capabilities* self)
{
