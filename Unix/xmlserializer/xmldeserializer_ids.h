...
#define ID_MI_DES_XML_KEYVALUE_TYPE_MISSMATCH 4015
...
#define ID_MI_DES_XML_KEYVALUE_TYPE_MISSMATCH           PAL_T("Failed to deserialize CIM-XML document. A KEYVALUE type does not match the class declaration.")
