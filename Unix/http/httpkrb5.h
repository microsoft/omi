...
#ifndef _omi_http_krb5_h
#define _omi_http_krb5_h

#if defined(CONFIG_HAVE_GSSAPI_EXT)

#include <gssapi/gssapi_ext.h>

#else

// Extracted from gssapi_ext.h. Used in httpclientauth.c
