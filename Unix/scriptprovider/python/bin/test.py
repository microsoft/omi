...
def timestamp_test ():
    ...
    m9 = random.randint (11, 20)
    d9 = random.randint (21, 30)
    h9 = random.randint (31, 40)
    min9 = random.randint (41, 50)
    s9 = random.randint (51, 60)
    ms9 = random.randint (61, 70)
    u9 = random.randint (71, 80)
