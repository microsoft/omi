...
NitsTest(TestSerializeClass2)
{
    const MI_Char expect[] =
        ...
        T("    S64 = -64;\n")
#if defined(_MSC_VER)
        T("    R32 = 1.00000000000000000000000E+000;\n")
        T("    R64 = 1.0000000000000000000000000000000000000000000000000000E+000;\n")
#else
...
#if defined(_MSC_VER)
        T("    R32A = {0.00000000000000000000000E+000};\n")
        T("    R64A = {0.0000000000000000000000000000000000000000000000000000E+000};\n")
#else
...
NitsTest(TestSerializeClass1Schema)
{
    ...
    const MI_Char expect[] =
        ...
        T("    Sint64 S64 = -64;\n")
#if defined(_MSC_VER)
        T("    Real32 R32 = 0.00000000000000000000000E+000;\n")
        T("    Real64 R64 = 0.0000000000000000000000000000000000000000000000000000E+000;\n")
#else
...
#if defined(_MSC_VER)
        T("    Real32 R32A[] = {0.00000000000000000000000E+000};\n")
        T("    Real64 R64A[] = {0.0000000000000000000000000000000000000000000000000000E+000};\n")
#else
