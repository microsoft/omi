...
//
// A proc running from a spawned thread to unsubscribe the indication operation(s)
//
...
//
// A proc running from a spawned thread to unsubscribe the indication provider
//
PAL_Uint32 THREAD_API noniothread_proc(void* p)
{
