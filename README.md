...
-------- |-------- |------------  | ---   | --------
Linux    | Debian  | x64          | 1.1.0 | [omi-1.4.0-6.ssl_110.ulinux.x64.deb](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_110.ulinux.x64.deb)
Linux    | Debian  | x64          | 1.0.0 | [omi-1.4.0-6.ssl_100.ulinux.x64.deb](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_100.ulinux.x64.deb)
Linux    | Debian  | x64          | 0.9.8 | [omi-1.4.0-6.ssl_098.ulinux.x64.deb](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_098.ulinux.x64.deb)
Linux    | RPM     | x64          | 1.1.0 | [omi-1.4.0-6.ssl_110.ulinux.x64.rpm](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_110.ulinux.x64.rpm)
Linux    | RPM     | x64          | 1.0.0 | [omi-1.4.0-6.ssl_100.ulinux.x64.rpm](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_100.ulinux.x64.rpm)
Linux    | RPM     | x64          | 0.9.8 | [omi-1.4.0-6.ssl_098.ulinux.x64.rpm](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_098.ulinux.x64.rpm)
Linux    | Debian  | x86          | 1.0.0 | [omi-1.4.0-6.ssl_100.ulinux.x86.deb](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_100.ulinux.x86.deb)
Linux    | Debian  | x86          | 0.9.8 | [omi-1.4.0-6.ssl_098.ulinux.x86.deb](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_098.ulinux.x86.deb)
Linux    | RPM     | x86          | 1.0.0 | [omi-1.4.0-6.ssl_100.ulinux.x86.rpm](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_100.ulinux.x86.rpm)
Linux    | RPM     | x86          | 0.9.8 | [omi-1.4.0-6.ssl_098.ulinux.x86.rpm](https://github.com/Microsoft/omi/releases/download/v1.4.0-6/omi-1.4.0-6.ssl_098.ulinux.x86.rpm)
...
```
sudo rpm -Uvh ./omi-1.4.0-6.ssl_100.ulinux.x64.rpm
```

- For DPKG based systems (Debian, Ubuntu, etc):
```
sudo dpkg -i ./omi-1.4.0-6.ssl_100.ulinux.x64.deb
```
