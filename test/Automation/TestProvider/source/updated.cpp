    ...
    const MI_Filter* filter)
{
	...
	original1.Country_value("Updated country value.");
...
void DemoTest_Class_Provider::Invoke_ChangeState(
    Context& context,
    const String& nameSpace,
    const DemoTest_Class& instanceName,
    const DemoTest_ChangeState_Class& in)
{
    DemoTest_Class updated;
	updated.Name_value("Updated Method.");
